      ...
      <nav className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-lg font-bold tracking-tight" data-testid="text-logo">HunterOS</span>
          </div>
        ...
        <section className="py-20 sm:py-28 px-4 border-t border-border">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
              Join solopreneurs who use HunterOS to stay organized, focused, and productive. Your command center awaits.
            </p>
      ...
      <footer className="border-t border-border py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold" data-testid="text-footer-logo">HunterOS</span>
          </div>
